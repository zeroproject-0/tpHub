...
public abstract class Database {
  ...
  // database to search for the player
  ...
  // this line!! And depending on how many
  ...
  // in order. Player is ID 1,
  // // kills is ID 2, Total would be 3 and so on. you can use
  // // setInt, setString and so on. tokens and total are just variables sent in,
  // You
